                            ...
                            @endif
                                    <div class="row">
                                        <div class="col-lg-6 col-12 mx-auto">
                                            <form method="POST" action="{{route('admin.ads')}}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label>slug</label>
                                                    <textarea name="slug" class="form-control" rows="3" placeholder="Enter ..."></textarea>
                                                </div>
                                                </div>
                                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td><p class="text-danger">{{$ad->$image}}</p></td>
                                                <td class="text-center">
                                                    <ul class="table-controls">
                                                        <li><a href="{{Route('admin.ads.update',[$ad->id])}}"  data-toggle="tooltip" data-placement="top" title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a></li>
