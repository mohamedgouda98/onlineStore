...
<html lang="en">
    <head>
        ...
        <link href="{{asset('userAssets/lib/slick/slick-theme.css')}}}" rel="stylesheet">
    ...
    <body>
                            ...
                            <form method="post" action="{{route('user.register')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" name="re-password" type="password" placeholder="Password">
                                    </div>
                                    <div class="col-md-12">
        ...
        <script src="{{asset('userAssets/lib/slick/slick.min.js')}}"></script>
